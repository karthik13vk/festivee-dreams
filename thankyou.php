...
<body>
  ...
  xs 480 -320 -->
        ...
        <div class="col_1">
          <div class="right-header  ">
            ...
            <div id="mySidenav" class="sidenav">
                ...
                <button class="dropdown-btn" title="Services">Services
    ...
    <!-- Breadcrumb part -->
    <div>
    <section class="breadcrumb-section breadcrumb-services-details thankyou-page section_padding">
        <div class="wrapper">
                ...
                <div class="col_1">
                    <div class="breadcrumb-part">
                        ...
                        <p class="breadcrumb-desc" data-aos="zoom-in" data-aos-duration="3000">
                            Thank You For Taking The Time To Send Us A Message, A Member Of Our Team Will Contact You
                            Shortly, If You Want To Have A Informal Chat With One Of Our Team Do Not Hesitate To Call
                            Us.
                        </p>
                    </div>
                </div>
